...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@uirouter/core'), require('rxjs'), require('rxjs/operators'), require('@angular/router'), require('@uirouter/rx')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@uirouter/core', 'rxjs', 'rxjs/operators', '@angular/router', '@uirouter/rx'], factory) :
    (global = global || self, factory(global['@uirouter/angular'] = {}, global.ng.core, global.ng.common, global['@uirouter/core'], global.rxjs, global.operators, global.ng.router, global['@uirouter/rx']));
}(this, function (exports, core, common, core$1, rxjs, operators, router, rx) { 'use strict';
    ...
    function ng2ViewsBuilder(state) {
        var views = {}, viewsObject = state.views || { $default: core$1.pick(state, ['component', 'bindings']) };
        core$1.forEach(viewsObject, function (config, name) {
            name = name || '$default'; // Account for views: { "": { template... } }
            if (core$1.isFunction(config))
            ...
            config.$name = name;
            var normalized = core$1.ViewService.normalizeUIViewTarget(config.$context, config.$name);
    ...
    var Ng2ViewConfig = /** @class */ (function () {
        ...
        Ng2ViewConfig.prototype.load = function () {
            return core$1.services.$q.when(this);
        };
    ...
    var UIView = /** @class */ (function () {
        ...
        Object.defineProperty(UIView.prototype, "state", {
            ...
            get: /**
               ...
               */
            function () {
                return core$1.parse('_uiViewData.config.viewDecl.$context.self')(this);
            },
            enumerable: true,
            configurable: true
        });
        ...
        function (trans) {
            ...
            if (core$1.isFunction(uiCanExitFn)) {
        ...
        function ($transition$) {
            ...
            if (core$1.isFunction(uiOnParamsChanged)) {
                var viewState = this.state;
                var resolveContext = new core$1.ResolveContext(this._uiViewData.config.path);
                ...
                if (changedToParams.length) {
                    ...
                    var newValues = core$1.filter(toParams_1, function (val, key) { return changedKeys_1.indexOf(key) !== -1; });
        ...
        function (config) {
            ...
            this._disposeLast();
            core$1.trace.traceUIViewConfigUpdated(this._uiViewData, config && config.viewDecl.$context);
        ...
        UIView.prototype._applyUpdatedConfig = function (config) {
            ...
            var context = new core$1.ResolveContext(config.path);
            var componentInjector = this._getComponentInjector(context);
            // Get the component class from the view declaration. TODO: allow promises?
            var componentClass = config.viewDecl.component;
            // Create the component
            var compFactoryResolver = componentInjector.get(core.ComponentFactoryResolver);
        ...
        function (context) {
            ...
            var moduleInjector = context.getResolvable(core$1.NATIVE_INJECTOR_TOKEN).data;
            var mergedParentInjector = new MergeInjector(moduleInjector, parentComponentInjector);
            return core.ReflectiveInjector.resolveAndCreate(newProviders, mergedParentInjector);
        };
        /**
        ...
        function (factory, component, context, componentClass) {
            ...
            var implicitInputTuples = ng2ComponentInputs(factory).filter(function (tuple) { return !core$1.inArray(explicitBoundProps, tuple.prop); });
        ...
        UIView.ctorParameters = function () { return [
            { type: core$1.UIRouter, },
            { type: undefined, decorators: [{ type: core.Inject, args: [UIView.PARENT_INJECT,] },] },
            { type: core.ViewContainerRef, },
        ]; };
        UIView.propDecorators = {
            "_componentTarget": [{ type: core.ViewChild, args: ['componentTarget', { read: core.ViewContainerRef },] },],
            "name": [{ type: core.Input, args: ['name',] },],
            "_name": [{ type: core.Input, args: ['ui-view',] },],
        };
        return UIView;
    }());
    ...
    function applyModuleConfig(uiRouter, injector, module) {
        ...
        if (core$1.isFunction(module.config)) {
    ...
    function applyRootModuleConfig(uiRouter, injector, module) {
        core$1.isDefined(module.deferIntercept) && uiRouter.urlService.deferIntercept(module.deferIntercept);
        core$1.isDefined(module.otherwise) && uiRouter.urlService.rules.otherwise(module.otherwise);
        core$1.isDefined(module.initial) && uiRouter.urlService.rules.initial(module.initial);
    }
    ...
    var AnchorUISref = /** @class */ (function () {
        ...
        AnchorUISref.decorators = [
            { type: core.Directive, args: [{ selector: 'a[uiSref]' },] },
        ];
        /** @nocollapse */
    ...
    var UISref = /** @class */ (function () {
        ...
        UISref.prototype.getOptions = function () {
            ...
            return core$1.extend(defaultOpts, this.options || {});
        };
        ...
        function (button, ctrlKey, metaKey) {
            if ((this._anchorUISref &&
                (this._anchorUISref.openInNewTab() || button || !core$1.isNumber(button) || ctrlKey || metaKey)) ||
                !this.state) {
                return;
            }
        ...
        UISref.ctorParameters = function () { return [
            { type: core$1.UIRouter, },
            { type: AnchorUISref, decorators: [{ type: core.Optional },] },
            { type: undefined, decorators: [{ type: core.Inject, args: [UIView.PARENT_INJECT,] },] },
        ]; };
        UISref.propDecorators = {
            "state": [{ type: core.Input, args: ['uiSref',] },],
            "params": [{ type: core.Input, args: ['uiParams',] },],
            "options": [{ type: core.Input, args: ['uiOptions',] },],
            "go": [{ type: core.HostListener, args: ['click', ['$event.button', '$event.ctrlKey', '$event.metaKey'],] },],
        };
        return UISref;
    }());
    ...
    var pathMatches = function (target) {
        ...
        var targetPath = core$1.PathUtils.buildPath(target);
        var paramSchema = targetPath
            .map(function (node) { return node.paramSchema; })
            .reduce(core$1.unnestR, [])
            .filter(function (param) { return targetParamVals.hasOwnProperty(param.id); });
        return function (path) {
            var tailNode = core$1.tail(path);
            if (!tailNode || tailNode.state !== state)
                return false;
            var paramValues = core$1.PathUtils.paramValues(path);
            return core$1.Param.equals(paramSchema, paramValues, targetParamVals);
        };
    };
    /**
    ...
    function spreadToSubPaths(basePath, appendPath) {
        return appendPath.map(function (node) { return basePath.concat(core$1.PathUtils.subPath(appendPath, function (n) { return n.state === node.state; })); });
    }
    /**
    ...
    var UISrefStatus = /** @class */ (function () {
        function UISrefStatus(_globals) {
            ...
            this.uiSrefStatus = new core.EventEmitter(false);
        ...
        UISrefStatus.ctorParameters = function () { return [
            { type: core$1.UIRouterGlobals, },
        ]; };
        UISrefStatus.propDecorators = {
            "uiSrefStatus": [{ type: core.Output, args: ['uiSrefStatus',] },],
            "_srefs": [{ type: core.ContentChildren, args: [UISref, { descendants: true },] },],
        };
        return UISrefStatus;
    }());
    ...
    var UISrefActive = /** @class */ (function () {
        ...
        UISrefActive.propDecorators = {
            "active": [{ type: core.Input, args: ['uiSrefActive',] },],
            "activeEq": [{ type: core.Input, args: ['uiSrefActiveEq',] },],
        };
        return UISrefActive;
    }());
    ...
    /** @hidden */ var UIROUTER_ROOT_MODULE = new core.InjectionToken('UIRouter Root Module');
    /** @hidden */ var UIROUTER_MODULE_TOKEN = new core.InjectionToken('UIRouter Module');
    /** @hidden */ var UIROUTER_STATES = new core.InjectionToken('UIRouter States');
    ...
    function makeRootProviders(module) {
        return [
            ...
            { provide: core.ANALYZE_FOR_ENTRY_COMPONENTS, useValue: module.states || [], multi: true },
            {
                provide: core.APP_INITIALIZER,
                useFactory: onTransitionReady,
                deps: [core$1.TransitionService, UIROUTER_ROOT_MODULE],
                multi: true,
            },
        ];
    }
    ...
    function loadNgModule(moduleToLoad) {
        return function (transition, stateObject) {
            var ng2Injector = transition.injector().get(core$1.NATIVE_INJECTOR_TOKEN);
    ...
    function loadModuleFactory(moduleToLoad, ng2Injector) {
        if (core$1.isString(moduleToLoad)) {
            return ng2Injector.get(core.NgModuleFactoryLoader).load(moduleToLoad);
        }
        var compiler = ng2Injector.get(core.Compiler);
    ...
    function applyNgModule(transition, ng2Module, parentInjector, lazyLoadState) {
        ...
        var uiRouter = injector.get(core$1.UIRouter);
        ...
        var newRootModules = multiProviderParentChildDelta(parentInjector, injector, UIROUTER_ROOT_MODULE).reduce(core$1.uniqR, []);
        var newChildModules = multiProviderParentChildDelta(parentInjector, injector, UIROUTER_MODULE_TOKEN).reduce(core$1.uniqR, []);
        ...
        var newParentStates = newStateObjects.filter(function (state) { return !core$1.inArray(newStateObjects, state.parent); });
        // Add the Injector to the top of the lazy loaded state tree as a resolve
        newParentStates.forEach(function (state) { return state.resolvables.push(core$1.Resolvable.fromData(core$1.NATIVE_INJECTOR_TOKEN, injector)); });
        return {};
    }
    /**
    ...
    ***************************************************************************** */
    ...
    Ng2LocationServices = /** @class */ (function (_super) {
        ...
        Ng2LocationServices.prototype._set = function (state, title, url, replace) {
            var _a = core$1.parseUrl(url), path = _a.path, search = _a.search, hash = _a.hash;
    ...
    var Ng2LocationConfig = /** @class */ (function (_super) {
        ...
        function Ng2LocationConfig(router, _locationStrategy) {
            var _this = _super.call(this, router, core$1.is(common.PathLocationStrategy)(_locationStrategy)) || this;
            _this._locationStrategy = _locationStrategy;
            return _this;
        }
    ...
    function uiRouterFactory(locationStrategy, rootModules, modules, injector) {
        ...
        var router = new core$1.UIRouter();
        // Add RxJS plugin
        router.plugin(rx.UIRouterRx);
        // Add $q-like and $injector-like service APIs
        router.plugin(core$1.servicesPlugin);
        // ----------------- Monkey Patches ----------------
        // Monkey patch the services.$injector to use the root ng2 Injector
        core$1.services.$injector.get = injector.get.bind(injector);
        // ----------------- Configure for ng2 -------------
        router.locationService = new Ng2LocationServices(router, locationStrategy, common.isPlatformBrowser(injector.get(core.PLATFORM_ID)));
        ...
        var ng2InjectorResolvable = core$1.Resolvable.fromData(core$1.NATIVE_INJECTOR_TOKEN, injector);
    ...
    var _UIROUTER_INSTANCE_PROVIDERS = [
        {
            provide: core$1.UIRouter,
            useFactory: uiRouterFactory,
            deps: [common.LocationStrategy, UIROUTER_ROOT_MODULE, UIROUTER_MODULE_TOKEN, core.Injector],
        },
        { provide: UIView.PARENT_INJECT, useFactory: parentUIViewInjectFactory, deps: [core$1.StateRegistry] },
        { provide: core.APP_INITIALIZER, useFactory: appInitializer, deps: [core$1.UIRouter], multi: true },
    ];
    ...
    var _UIROUTER_SERVICE_PROVIDERS = [
        { provide: core$1.StateService, useFactory: fnStateService, deps: [core$1.UIRouter] },
        { provide: core$1.TransitionService, useFactory: fnTransitionService, deps: [core$1.UIRouter] },
        { provide: core$1.UrlMatcherFactory, useFactory: fnUrlMatcherFactory, deps: [core$1.UIRouter] },
        { provide: core$1.UrlRouter, useFactory: fnUrlRouter, deps: [core$1.UIRouter] },
        { provide: core$1.UrlService, useFactory: fnUrlService, deps: [core$1.UIRouter] },
        { provide: core$1.ViewService, useFactory: fnViewService, deps: [core$1.UIRouter] },
        { provide: core$1.StateRegistry, useFactory: fnStateRegistry, deps: [core$1.UIRouter] },
        { provide: core$1.UIRouterGlobals, useFactory: fnGlobals, deps: [core$1.UIRouter] },
    ];
    /**
